...
<div class="sidebarL">
    ...
    <form action="/addOrderCard" method="post">
        <div class="form-group row">
            <label for="_model" class="col-sm-2 col-form-label">Название карты: </label>
            <div class="col-sm-10">
               <h5>${card.cardname}</h5>
                <input type="hidden" name="idcard" id="idcard" class="form-control" value="${card.idcard}">
            </div>
        </div>
